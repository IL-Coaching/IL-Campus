...
export default function VistaMicrociclo({ semana, onSelectSesion }: VistaMicrocicloProps) {
    ...
    const handleCopySemana = () => {
        ...
        toast.info("Estructura de la semana copiada.");
    };
    ...
    const handlePasteSemana = async () => {
        ...
        if (res.exito) {
            router.refresh();
            toast.exito("Semana clonada con éxito.");
        } else {
            toast.error("Error al pegar semana: " + res.error);
        }
        setPasting(false);
    };
    ...
    const handleCrearSesion = async (dia: string) => {
        ...
        if (res.exito) {
            ...
            toast.error("Error al crear sesión: " + res.error);
        }
        setIsCreating(false);
    };
