...
export default function Loading() {
    return (
        <div className="w-full h-[70vh] flex flex-col items-center justify-center animate-in fade-in duration-300">
            ...
            <h2 className="text-blanco font-barlow-condensed text-xl uppercase tracking-widest font-black">Recuperando Expediente...</h2>
            <p className="text-gris text-xs font-bold uppercase tracking-[0.2em] mt-2 flex items-center gap-2">
                <Loader2 size={12} className="animate-spin" /> Obteniendo métricas y registros del cliente
            </p>
        </div>
    );
}
