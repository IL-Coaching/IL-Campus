...
import MetricasFuerzaClient from "./MetricasFuerzaClient";
...
export interface ResumenMetricasData {
...
interface Props {
    clienteId: string;
    datos: ResumenMetricasData;
    registrosFuerza: FuerzaRecord[];
}

export default function TabMetricasClient({ datos, registrosFuerza }: Omit<Props, 'clienteId'>) {
    ...
    return (
        <div className="space-y-8 fade-up visible">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-marino-2 border border-marino-4 p-6 rounded-2xl text-center shadow-lg group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-naranja/50">
                    ...
                    <span className="text-4xl font-barlow-condensed font-black text-transparent bg-clip-text bg-gradient-to-r from-blanco to-gris-claro">
                ...
                <div className="bg-marino-2 border border-marino-4 p-6 rounded-2xl text-center shadow-lg group transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-blue-400/50">
                ...
                <div className="bg-marino-2 border border-marino-4 p-6 rounded-2xl text-center shadow-lg group transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-green-500/50">
            ...
            <div className="bg-gradient-to-br from-marino-2 to-marino-3 border border-marino-4 p-8 rounded-3xl shadow-xl">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h4 className="text-xl font-barlow-condensed font-black uppercase text-transparent bg-clip-text bg-gradient-to-r from-blanco to-gris-claro">Curva de Tonelaje Semanal</h4>
            ...
            {datos?.adherencia && datos.adherencia.patronesIncumplimiento.length > 0 && (
                <div className="bg-gradient-to-br from-marino-2 to-marino-3 border border-marino-4 p-8 rounded-3xl">
                    <div className="flex items-center gap-3 mb-6">
                        <AlertCircle className="text-naranja" size={20} />
                        <h4 className="text-xl font-barlow-condensed font-black uppercase text-transparent bg-clip-text bg-gradient-to-r from-blanco to-gris-claro">Análisis de Patrones Críticos</h4>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {datos.adherencia.patronesIncumplimiento.map((p) => (
                            <div key={p.ejercicioId} className="bg-marino-3/50 border border-marino-4 p-4 rounded-2xl flex items-center justify-between group hover:border-naranja/40 hover:-translate-y-1 transition-all duration-300">
                                <div>
                                ...
                                <div className="text-right">
                                    ...
                                    <div className="w-12 h-1 bg-rojo/20 rounded-full mt-1 overflow-hidden">
                                        <div className="h-full bg-rojo transition-all duration-1000" style={{ width: `${p.frecuenciaSalto}%` }}></div>
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <MetricasFuerzaClient records={registrosFuerza} />
        </div>
    );
}
