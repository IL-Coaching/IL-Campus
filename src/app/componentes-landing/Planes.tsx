        ...
        <section id="planes" className="bg-marino py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
                    ...
                    {/* Plan 1 - Start */}
                    <div className="bg-marino-2 border border-marino-4 p-8 flex flex-col fade-up hover:-translate-y-1 transition-transform duration-200">
                        ...
                        <div className="bg-naranja/15 border border-naranja/40 text-naranja text-xs font-bold uppercase px-3 py-1.5 inline-block mb-6 shadow-sm">
                        ...
                        <ul className="space-y-4 mb-8 flex-grow">
                            {["Plan personalizado", "Seguimiento directo", "Guía de entrenamiento", "Videollamada semanal"].map((b, i) => (
                                <li key={i} className="flex items-center gap-3">
                                    <span className="text-naranja text-lg leading-none">✓</span>
                        ...
                        <button
                            ...
                            className="mt-auto w-full border border-marino-4 hover:border-naranja hover:text-naranja transition-colors text-blanco font-bold py-3 text-sm uppercase tracking-wide text-center bg-transparent"
                        >
                            Seleccionar
                        </button>
                    </div>
                    ...
                    <div className="bg-marino-2 border border-naranja p-8 flex flex-col fade-up relative lg:scale-[1.03] z-10 hover:-translate-y-1 transition-transform duration-200 shadow-2xl shadow-naranja/10">
                        {/* Esquina glow */}
                        <div className="absolute top-0 left-0 w-32 h-32 bg-naranja/10 blur-3xl rounded-full"></div>

                        <div className="absolute top-0 right-0 bg-naranja text-marino text-[0.65rem] font-bold uppercase tracking-widest px-4 py-1 rounded-bl-lg">
                            Más popular
                        </div>
                        ...
                        <p className="text-gris text-sm mb-6 border-b border-marino-4 pb-6 font-medium">3 Meses · 90 días</p>

                        <div className="mb-6">
                            <span className="text-4xl font-barlow-condensed font-black text-naranja tracking-tight">$40.000</span>
                        </div>

                        <p className="text-naranja font-semibold mb-6 text-sm">→ Para entrenar con estructura y empezar a progresar en serio</p>

                        <ul className="space-y-4 mb-8 flex-grow">
                            <li className="flex items-center gap-3">
                                <span className="text-gris text-lg leading-none">✓</span>
                            ...
                            {["Planificación por mesociclo", "Explicación detallada del entrenamiento", "Mayor comprensión del proceso"].map((b, i) => (
                                <li key={i} className="flex items-center gap-3">
                                    <span className="text-naranja text-lg leading-none">✓</span>
                                    <span className="text-blanco font-medium text-sm">{b}</span>
                                </li>
                            ))}
                        </ul>
                        ...
                        <button
                            ...
                            className="mt-auto w-full border border-naranja bg-naranja hover:bg-naranja-h transition-colors text-marino font-bold py-3 text-sm uppercase tracking-wide text-center"
                        >
                            Seleccionar
                        </button>
                    </div>
                    ...
                    <div className="bg-marino-2 border border-marino-4 p-8 flex flex-col fade-up hover:-translate-y-1 transition-transform duration-200">
                        ...
                        <ul className="space-y-4 mb-8 flex-grow">
                            ...
                            {["Macrociclo completo", "Análisis del proceso", "Ajustes estratégicos"].map((b, i) => (
                                <li key={i} className="flex items-center gap-3">
                                    <span className="text-naranja text-lg leading-none">✓</span>
                                    <span className="text-gris-claro font-medium text-sm">{b}</span>
                                </li>
